...
exports.setProyectoexpo = function(req,res){
    ...
    Proyectoexpo.create(
    {nombre: req.body.nombre,idproyecto: req.body.idproyecto,especialidad: req.body.especialidad,nivel:req.body.nivel,aula:req.body.aula,urllogo:req.body.urllogo,integrantes:[],materialesnoelectronicos:[],materialeselectronicos:[]},
        function(err, proyectoexpo){
            if(err)
                res.send(err);
...
exports.annadirmaterialesnoelectronicos = function(res, proyectoexpo) {
    Proyectoexpo.update( {nombre : req.body.nombre},
