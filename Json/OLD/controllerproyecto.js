...
exports.setProyectoexpo = function(req,res){
    ...
    Proyectoexpo.create(
    {nombre: req.body.nombre,especialidad: req.body.especialidad,nivel:req.body.nivel,integrantes:[],materialesnoelectronicos:[],materialeselectronicos:[], aula: req.body.aula, seccion: req.body.seccion, codigo: req.body.codigo},
        function(err, proyectoexpo){
            if(err)
                res.send(err);
